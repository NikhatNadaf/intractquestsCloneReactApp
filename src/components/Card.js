...
function Card() {
  return (
    <div className="flex flex-col h-min w-[19em] relative left-[957px] bottom-[300px] ">
      ...
      <div className="bg-black rounded-lg shadow-lg p-4 w-min md:w-fit">
        ...
        <div className="p-2">
          <h2 className="text-lg font-semibold text-white text-[1.3em]">Intract Certified: Learner NFT</h2>
          <p className="text-gray-600">Your crypto black-belt certificate</p>
